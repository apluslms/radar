...
def tokenize(source, config):
    """
    Runs the CSS tokenizer with Node.js in a subprocess and returns the token string and token index pairs as a JSON string.
    """
    try:
        parsed = run(("node", "tokenizer/css/tokenizer.js"), source)
